...
gamebg = pygame.image.load("sprites/bgbgbg.png")
...
#     midimg, midimgsize = image_load_downscale("sprites/0_1_Idle.png", 7)
#     mpg, mpgs = image_load_downscale("sprites/0_1_Punch.png", 7)
#     leftimg, leftimgsize = image_load_downscale("sprites/0_0_Idle.png", 7)
#     lpg, lpgs = image_load_downscale("sprites/0_0_Punch.png", 7)
#     rightimg, rightimgsize = image_load_downscale("sprites/0_2_Idle.png", 7)
#     rpg, rpgs = image_load_downscale("sprites/0_2_Punch.png", 7)
# elif difficulty == MEDIUM: # Timon DONE
#     midimg, midimgsize = image_load_downscale("sprites/1_1_Idle.png", 7)
#     mpg, mpgs = image_load_downscale("sprites/1_1_Punch.png", 7)
#     leftimg, leftimgsize = image_load_downscale("sprites/1_0_Idle.png", 7)
#     lpg, lpgs = image_load_downscale("sprites/1_0_Punch.png", 7)
#     rightimg, rightimgsize = image_load_downscale("sprites/1_2_Idle.png", 7)
#     rpg, rpgs = image_load_downscale("sprites/1_2_Punch.png", 7)
# elif difficulty == HARD: # Eli
#     midimg, midimgsize = image_load_downscale("sprites/5_1_Idle.png", 7)
#     mpg, mpgs = image_load_downscale("sprites/5_1_Punch.png", 7)
#     leftimg, leftimgsize = image_load_downscale("sprites/5_0_Idle.png", 7)
#     lpg, lpgs = image_load_downscale("sprites/5_0_Punch.png", 7)
#     rightimg, rightimgsize = image_load_downscale("sprites/5_2_Idle.png", 7)
#     rpg, rpgs = image_load_downscale("sprites/5_2_Punch.png", 7)
...
#     midimg, midimgsize = image_load_downscale("sprites/2_1_Idle.png", 7)
#     mpg, mpgs = image_load_downscale("sprites/2_1_Punch.png", 7)
#     leftimg, leftimgsize = image_load_downscale("sprites/2_0_Idle.png", 7)
#     lpg, lpgs = image_load_downscale("sprites/2_0_Punch.png", 7)
#     rightimg, rightimgsize = image_load_downscale("sprites/2_2_Idle.png", 7)
#     rpg, rpgs = image_load_downscale("sprites/2_2_Punch.png", 7)


player_idle_1_img, player_idle_1_img_size = image_load_downscale("sprites/playeridle1.png", 12)
player_idle_2_img, player_idle_2_img_size = image_load_downscale("sprites/playeridle2.png", 12)
player_punch_img, player_punch_img_size = image_load_downscale("sprites/playerpunch.png", 12)
